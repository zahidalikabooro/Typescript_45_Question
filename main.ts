...
//Task 3
let person_name:string  = "Zahid Ali";
...
//Task 4
let famous_person: string = "Alber Einstein said : ";
...
//||||||||||||||||||||||||||||||||||||||||||||||
//Task 6
let whitespace:string = "      Imran Khan       ";
...
const answer = await inquirer.prompt([
    {
        type: "input", // input mean string type
        name: "name",   // it will store user output
...
// Task 19
let Guest: string[] = ["Imran khan","Shahbaz Shareef","Alber Einstein","Ibrahim Raisi","Sharejeel"]
...
//Task 22
let friends : string[] =["Ali","Zahid","Aslam"];
...
// Task 32
let current_users: string[] =["Zahid","Ali","Kabooro","Mehbob","Mujtaba"];
let new_users: string[] =["Zahid","Mujtaba","Aslam","Khan","Sanaullah"]
...
// Task 34
let favrt_Pizza: string[] = ["Margherita Pizza","Pepperoni Pizza","BBQ Chicken Pizza"]
...
// Task 41
let magicians: string[] = ["Zahid", "Ali", "Aslam"];
